...
- [ ] **Fix and ensure sparkline graphs look okay**
- [ ] **Audit SQLite and Turso usage** — Ensure we aren't approaching Turso usage limits.
- [ ] **Set up website monitoring** — To know if the website is unreachable or has problems.
